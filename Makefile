...
deploy:
	...
	ssh -o "UserKnownHostsFile=/dev/null" -o "StrictHostKeyChecking=no" root@192.168.2.15 -- nixos-rebuild switch --flake "github:HeinrichHartmann/2024-02-18-nixos-rpi4-flake.git?rev=$$(git rev-parse HEAD)#pi"
